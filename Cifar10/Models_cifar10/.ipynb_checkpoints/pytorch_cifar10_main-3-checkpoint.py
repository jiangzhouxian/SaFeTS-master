...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='checkpoint/DenseNet121-CIFAR10.pth')
    ...
    plt.title('DenseNet121-CIFAR10-Accurancy')
    plt.legend()
    plt.savefig('output/DenseNet121-CIFAR10-Accurancy.jpg')  # 自动保存plot出来的图片
    plt.show()
